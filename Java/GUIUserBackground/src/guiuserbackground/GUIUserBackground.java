...
// Supplies preferred size to each panel

import javax.swing.*;    
import java.awt.*;
import java.util.Random;       

public class GUIUserBackground{

   public static void main(String[] args){
      JFrame theGUI = new JFrame();
      theGUI.setTitle("GUI Example");
      String inputStr = JOptionPane.showInputDialog("Number of rows", "50");
      if (inputStr == null) return;
      int rows = Integer.parseInt(inputStr);
      inputStr = JOptionPane.showInputDialog("Number of columns", "50");
      if (inputStr == null) return;
